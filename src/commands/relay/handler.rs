...
///
/// Copilot-capable relays MITM `githubcopilot.com`; everyone else blind-tunnels it
/// so their MCP servers reach the real host with the real certificate.
...
/// `intercept_copilot_hosts` is set for a Copilot-capable relay.
...
pub struct RelayHandler {
    ...
    /// for Copilot-capable relays; other relays blind-tunnel it so their MCP
    /// servers reach the real host without hitting the Edgee CA.
