...
| --- | --- | --- | --- |
| **A. Environment / config injection** | Sets documented env vars or CLI config flags on the child process only | `claude`, `codex`, `opencode`, `codebuddy`, `crush`, `kilo` | **Yes.** Each variable below links to the vendor's own docs |
